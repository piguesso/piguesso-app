const TextStyles = {
  H1: "font-black text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl leading-tighter dark:text-white text-black tracking-tight",
  H1Gradient:
  ...
  H2: "font-black text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-7xl leading-tighter dark:text-white text-black tracking-tight",
  H2Gradient:
  ...
  H3: "font-black text-3xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl leading-tighter dark:text-white text-black tracking-tight",
  H3Gradient:
  ...
  H4: "font-black text-xl sm:text-2xl md:text-3xl lg:text-3xl xl:text-4xl leading-tighter dark:text-white text-bold tracking-tight",
